...
public class AlipayClient {
     ...
     */
    public static ResponseEntity preCreate(AlipayQrcodeRequest request, AlipayCore alipayCore) throws Exception{
     ...
     * @throws Exception the exception
     */
    public static  ResponseEntity pay(AlipayTradeRequest request, AlipayCore alipayCore) throws Exception{
     ...
     * @throws Exception the exception
     */
    public static  ResponseEntity query(String outTradeNo, AlipayCore alipayCore) throws Exception {
     ...
     * @throws Exception the exception
     */
    public static  ResponseEntity refund(AlipayRefundRequest request, AlipayCore alipayCore) throws Exception{
     ...
     * @throws Exception the exception
     */
    public static  ResponseEntity cancel(String outTradeNo, AlipayCore alipayCore) throws Exception {
