...
import com.ykc.entity.ali.GoodsDetail;
import lombok.Data;
 ...
 * @Description 支付宝-统一收单下单并支付页面接口请求对象
 * @Author hgq
 * @Date 2020/3/1 13:03
 * @Version 1.0
 */
...
//        bizContent.scene = "wave_code";
    ...
    static class BizContent {
        ...
        // 必选：商户订单号系统中唯一，64个字符以内，只能包含字母、数字、下划线，
        ...
        // 必选：订单总金额，整形，此处单位为元，精确到小数点后2位，不能超过1亿元
        ...
        // 必选：订单标题，粗略描述用户的支付目的。如“喜士多（浦东店）消费”
        ...
        // 可选：商户门店编号，例如：NJ_001，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        @SerializedName("store_id")
        private String storeId;

        // 可选：支付宝商家平台中配置的商户门店号，详询支付宝技术支持
        @SerializedName("alipay_store_id")
        private String alipayStoreId;

        // 可选：商户机具终端编号，当以机具方式接入支付宝时必传，详询支付宝技术支持
